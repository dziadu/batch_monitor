...
import collections
from batch_farm_monitor import update
...
class SimpleTest(TestCase):
    ...
    def test_update_slurm(self):
        jobs1 = (
            "JOBID USER PARTITION TIME_LIMIT STATE TIME PRIORITY\n"
            "7574 rlalik farmq 10:00 RUNNING 0:15 0\n"
            "7576 rlalik farmq 10:00 RUNNING 0:15 0\n")

        jobs2 = (
            "JOBID USER PARTITION TIME_LIMIT STATE TIME PRIORITY\n"
            "7574 rlalik farmq 10:00 RUNNING 0:15 0\n"
            "7576 rlalik farmq 10:00 RUNNING 0:15 0\n"
            "7577 tkunz farmq 10:00 RUNNING 0:15 0\n"
            "7578 tkunz farmq 10:00 RUNNING 0:15 0\n"
            "7579 tkunz farmq 10:00 RUNNING 0:15 0\n"
            "7580 tkunz farmq 10:00 RUNNING 0:15 0\n")
    ...
    def test_comapre_jid(self):
        self.assertEqual(compare_jid("123", "124"), -1)
        self.assertEqual(compare_jid("123", "122"), 1)
        self.assertEqual(compare_jid("123", "123"), 0)
        self.assertEqual(compare_jid("123_1", "123"), 0)
        self.assertEqual(compare_jid("123_2", "123_3"), -1)
        self.assertEqual(compare_jid("123_2", "123_1"), 1)
        self.assertEqual(compare_jid("123_1", "124"), -1)
        self.assertEqual(compare_jid("123_1", "122"), 1)
